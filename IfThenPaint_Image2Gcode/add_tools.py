...
tool_1 = {'name': '4_round',
          ...
          'profile_width': 3, # tool profile width along y axis when tool is docked (i.e. A0B0C0)
          'profile_length': 3, # tool profile width along x axis when tool is docked (i.e. A0B0C0) 
          'x_dock': 48,
          'y_dock': 328,
